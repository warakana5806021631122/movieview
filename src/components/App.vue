...
<script>
  ...
  const config = {
    apiKey: 'AIzaSyBslvDNf-QceZfJfkKCIIWg-pbNLLfEGSA',
    authDomain: 'movies-66efe.firebaseapp.com',
    databaseURL: 'https://movies-66efe.firebaseio.com',
    projectId: 'movies-66efe',
    storageBucket: 'movies-66efe.appspot.com',
    messagingSenderId: '285587696649'
  }
